...
class LeafEmitters:
 ...
 """
        ...
        for unrollElems, fragReg in ctx.fragments:
            ...
            # MXS unit indices already name scalar lanes; its b64 write starts at that lane. Other
            # reads index instruction-width groups and therefore scale by `wtRegStride`.
